...
public class RecetaDao extends HttpServlet {
    ...
    public static List<Receta> getReceipesCalories(String calorie) {
        List<Receta> list = new ArrayList<>();
    ...
    public static List<Receta> getReceipesMaxTime(String maxTime) {
        List<Receta> list = new ArrayList<>();
    ...
    public static List<Receta> getReceipesMinTime(String minTime) {
        List<Receta> list = new ArrayList<>();
        ...
        try {
            ...
            while (results.hasNext()) {
                ...
                System.out.print(rec.getCalorias());
    ...
    public static List<Receta> getReceipesBetweenMinMax(String minTime, String maxTime) {
        List<Receta> list = new ArrayList<>();
    ...
    public static List<Receta> getReceipesDifficulty() {
        List<Receta> list = new ArrayList<>();
    ...
    public static List<Receta> getReceipesEasyMediumDif() {
        List<Receta> list = new ArrayList<>();
    ...
    public static List<Receta> getReceipesMediumHardDif() {
        List<Receta> list = new ArrayList<>();
